...
function PrivacyPolicyContentInner() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-background shadow rounded-lg">
      ...
      <p className="text-sm text-gray-500">{t('lastUpdated')}: May 3, 2025</p>
      ...
      <section className="mt-6 mb-8">
        ...
        <p className="text-sm text-muted-foreground">
          {t('privacyContact')} <a href="mailto:neo.js.cn@gmail.com" className="text-blue-600 underline">neo.js.cn@gmail.com</a>.
        </p>
      </section>
    </div>
  );
