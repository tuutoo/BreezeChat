...
import { Database, Bot, LogOut, BookOpen, Settings } from "lucide-react";
	...
	return (
		<div className="container mx-auto py-10">
			...
			<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
				...
				<Link href="/admin/additional-prompts">
					<Card className="hover:bg-accent/50 transition-colors cursor-pointer">
						<CardHeader>
							<CardTitle className="flex items-center gap-2">
								<Settings className="h-5 w-5" />
								{t("admin.additionalPromptManagement")}
							</CardTitle>
							<CardDescription>
								{t("admin.additionalPromptDescription")}
							</CardDescription>
						</CardHeader>
					</Card>
				</Link>
